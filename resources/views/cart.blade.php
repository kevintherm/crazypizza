                                    ...
                                    <div class="flex-grow">
                                        <div class="flex items-baseline justify-between">
                                            <div>
                                                ...
                                                <p class="text-sm leading-tight" x-text="`Contains: ${item.pizza.ingredients.map(e => e.name).join(', ')}`"></p>
                                            </div>
                                        ...
                                        <div x-data="{
                                            ...
                                            <button class="text-md text-black flex items-center gap-2" @click="showToppings = !showToppings">
                                                Add Toppings
                                                <svg class="size-5 duration-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
