...
<x-admin.layout title="Manage Coupons">
    ...
    <main x-data="$store.mg" class="flex flex-col px-6 md:px-12">
        ...
        <section id="header" class="relative flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
                <h1 class="text-2xl">Manage Coupons</h1>
                <p class="opacity-90">Manage your coupons here.</p>
            </div>
    ...
    <x-slot name="foot">
            ...
            <x-slot name="form">
                <div class="grid grid-cols-12 gap-2 md:gap-4">
                    ...
                    <div class="col-span-12 md:col-span-3">
                        <label class="w-fit pl-0.5 text-sm capitalize" for="code">Code</label>
                    </div>
                    <div class="col-span-12 md:col-span-9">
                        <input x-model="$store.mg.selectedItem.code" id="code" name="code"
                    ...
                    <div class="col-span-12 md:col-span-3">
                        <label class="w-fit pl-0.5 text-sm capitalize" for="quota">Quota</label>
                    </div>
                    <div class="col-span-12 md:col-span-9">
                        <input x-model="$store.mg.selectedItem.quota" id="quota" name="quota"
                               class="rounded-radius border-outline bg-surface-alt text-md focus-visible:outline-primary dark:border-outline-dark dark:bg-surface-dark-alt/50 dark:focus-visible:outline-primary-dark w-full border px-3 py-2 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-75"
                               type="number" min="0" max="999" autocomplete="off" required />
                    </div>
                    <div class="col-span-12 md:col-span-3">
                        <label class="w-fit pl-0.5 text-sm capitalize" for="discount">Discount</label>
                    </div>
                    <div class="col-span-12 md:col-span-9">
                        <div class="relative">
                            ...
                            <input x-mask:dynamic="$money($input)" x-model="$store.mg.selectedItem.discount" id="discount" name="discount"
                    ...
                    <div class="col-span-12 md:col-span-3">
                        <label class="w-fit pl-0.5 text-sm capitalize" for="is_active">Is Active</label>
                    </div>
                    <div class="col-span-12 md:col-span-9">
                        <select x-model="$store.mg.selectedItem.is_active" id="is_active" name="is_active"
                                class="rounded-radius border-outline bg-surface-alt text-md focus-visible:outline-primary dark:border-outline-dark dark:bg-surface-dark-alt/50 dark:focus-visible:outline-primary-dark w-full border px-3 py-2 focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-75"
                                required>
        ...
        <script>
            const config = {
                ...
                routes: {
                    fetch: "{{ route('coupons.dataTable') }}",
                    createUpdate: "{{ route('coupons.createUpdate') }}",
                    delete: "{{ route('coupons.delete') }}",
                    bulkDelete: "{{ route('coupons.bulkDelete') }}",
                },
