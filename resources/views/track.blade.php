        ...
        <div class="flex flex-col min-h-[25vh] relative overflow-hidden">
            ...
            <div class="bg-[#E53935] py-6 px-8 md:px-24 ">
                ...
                <div class="max-w-xl md:ml-24 mt-24 mx-auto relative z-10">
                    ...
                    <p class="italic font-medium text-white">Give it your invoice and it will find your order!</p>
                </div>
            </div>
                ...
                <div class="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
                    <form class="mx-auto max-w-xl" action="" method="POST">
                        ...
                        <div class="mt-10 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div class="p-6">
                                <div class="relative z-[2] flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
